...
<div class="row">
  <div class="col-lg-5">
    @if ($pegawai->foto)
    <div class="mb-3">
      <img src="{{ url('foto').'/' . $pegawai->foto }}" width="500" class="img img-rounded">
    </div>
  @endif
  </div>
</div>

  <form method="POST" action="{{ url("pegawai/$pegawai->id") }}" enctype="multipart/form-data" class="form-inline mb-2">  
